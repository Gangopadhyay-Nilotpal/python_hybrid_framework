...
class AddCustomer:
    ...
    lstitemAdministrators_xpath = "//option[contains(text(),'Administrators')]"
    lstitemRegistered_xpath = "//option[contains(text(),'Registered')]"
    lstitemGuests_xpath = "//option[contains(text(),'Guests')]"
    lstitemVendor_xpath = "//option[contains(text(),'Vendors')]"
    lstitemForumModerators_xpath = "//option[contains(text(),'Forum Moderators')]"
